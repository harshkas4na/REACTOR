...
const mockProps = {
  ...
  connectedAccount: '0x742d35Cc6234C4532D9f4854BA6C1234567891011'
};

const EnhancedFundingRequirementsCard = ({ 
  ...
  const isMainnetOrAvalanche = connectedChain?.id === '1' || connectedChain?.id === '43114';
  ...
  // Handle sending SepETH to REACT faucet (FIXED VERSION)
        ...
        <CardContent className="p-4 sm:p-6">
          <div className="flex flex-col sm:flex-row items-start space-y-3 sm:space-y-0 sm:space-x-3">
            ...
            <div className="flex-1">
              <h3 className="font-medium text-amber-100 mb-2 text-sm sm:text-base">Testnet Setup Costs</h3>
              <p className="text-xs sm:text-sm text-amber-200 mb-3">
                RSC Monitoring: 0.05 REACT • Callback Execution: 0.03 SepETH • Plus gas fees
              </p>
              
              <div className="space-y-3">
                <div>
                  <p className="text-xs sm:text-sm text-amber-200 mb-2">
                    <span className="font-medium">Step 1:</span> Get Sepolia ETH from{' '}
                    <a
  ...
  // For mainnet/avalanche and other networks
  return (
    <Card className="relative bg-gradient-to-br from-blue-900/30 to-purple-900/30 border-zinc-800 mt-4 sm:mt-6">
      <CardContent className="p-4 sm:p-6">
        <div className="flex flex-col sm:flex-row items-start space-y-3 sm:space-y-0 sm:space-x-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs sm:text-sm text-amber-200 mb-3">
              RSC Monitoring: 0.05 REACT • Callback Execution: 0.03 {connectedChain?.nativeCurrency || 'ETH'} • Plus gas fees
            </p>
            ...
            {isMainnetOrAvalanche && (
              <div className="flex items-center space-x-2 mb-3">
                ...
                <p className="text-xs text-orange-300">
                  {connectedChain?.name} support coming soon - switch to Sepolia for testing
                </p>
              </div>
            )}
...
export default EnhancedFundingRequirementsCard;