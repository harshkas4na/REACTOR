// templates/blockchainWide/rsc.template.ts

export const blockchainWideRSCTemplate = `
...
contract ReactiveSmartContract is {{BASE_CONTRACT}} {
    ...
    constructor() {
        ...
        if (!vm) {
            service.subscribe(
                ORIGIN_CHAIN_ID,
                address(0),  // Monitor all contracts
                {{EVENT_TOPIC}},
                REACTIVE_IGNORE,
                REACTIVE_IGNORE,
                REACTIVE_IGNORE
...
// templates/blockchainWide/destination.template.ts
